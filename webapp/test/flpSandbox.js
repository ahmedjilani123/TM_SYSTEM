		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tmstmssystem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tmstmssystem-display": {
								"semanticObject": "tmstmssystem",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tms.tmssystem",
									"url": sap.ui.require.toUrl("tms/tmssystem")
								}
							}
						}
					}
